<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Events.ascx.cs" Inherits="TargetPoker.Client.controls.Events" %>
        ...
        <div class="container2">
            <div class="slides2">
                <asp:Repeater ID="rptEventos" runat="server">
                    <ItemTemplate>
                        <div>
                            <span class="button"><%# Eval("Date") %></span>
...
<h6>
    <asp:Label ID="lblEmBreve" runat="server" Text="Não existem eventos agendados." Visible="false"></asp:Label></h6>
